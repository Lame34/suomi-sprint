...
/**
 * Word list page for a vocabulary category.
 * Route: /learn/vocab/:categoryId
 */
export function WordList() {
  ...
  const items = useMemo(() => (categoryId ? getVocabByCategory(categoryId) : []), [categoryId]);
  ...
  return (
    <div className="page-enter space-y-4">
      ...
      {/* Start lesson button */}
      <button
        onClick={() => navigate(`/practice?category=${categoryId}&type=vocab&autostart=true`)}
